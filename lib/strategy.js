...
function Strategy(options, verify) {
  ...
  this._skipUserProfile = (options.skipUserProfile === undefined) ? function() {
    if (verify.length >= 8) { return false; }
    return true;
          ...
          function loaded(uiProfile, json, body) {
            ...
            try {
              if (self._passReqToCallback) {
                ...
                if (arity == 9) {
                  self._verify(req, iss, uiProfile, idProfile, idToken, accessToken, refreshToken, params, verified);
                } else if (arity == 8) {
                ...
                var arity = self._verify.length;
                if (arity == 8) {
                  self._verify(iss, uiProfile, idProfile, idToken, accessToken, refreshToken, params, verified);
                } else if (arity == 7) {
