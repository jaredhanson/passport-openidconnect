          ...
          function loaded(uiProfile, json, body) {
            ...
            try {
              if (self._passReqToCallback) {
                ...
                if (arity == 9) {
                  self._verify(req, claims.iss, uiProfile, idProfile, idToken, accessToken, refreshToken, params, verified);
                } else if (arity == 8) {
                  self._verify(req, claims.iss, profile, idToken, accessToken, refreshToken, params, verified);
                } else if (arity == 7) {
                  self._verify(req, claims.iss, profile, idToken, accessToken, refreshToken, verified);
                } else if (arity == 5) {
                  self._verify(req, claims.iss, profile, idToken, verified);
                } else { // arity == 4
                ...
                var arity = self._verify.length;
                if (arity == 8) {
                  self._verify(claims.iss, uiProfile, idProfile, idToken, accessToken, refreshToken, params, verified);
                } else if (arity == 7) {
                  self._verify(claims.iss, profile, idToken, accessToken, refreshToken, params, verified);
                } else if (arity == 6) {
                  self._verify(claims.iss, profile, idToken, accessToken, refreshToken, verified);
                } else if (arity == 4) {
                  self._verify(claims.iss, profile, idToken, verified);
                } else { // arity == 3
